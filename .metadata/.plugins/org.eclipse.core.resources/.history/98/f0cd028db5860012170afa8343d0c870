...
public class SymbolAssignment {
	...
	protected BiMap<Integer, Integer> piTranslate; //List of UPIs and mac addresses
	...
	public void add(int pi) { //Adds a pi to the pool available to have symbols assigned to them
