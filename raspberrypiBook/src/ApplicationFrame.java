...
/*		Order order8 = new Order(1295,false, 10, 25, 12, 1212, null, null, null, null, null);
		...
		book.removeOrder(1295);
		
		
	//	System.out.println(book.SellTree.getLimit(25).headOrder.idNumber);
		System.out.println(book.SellTree.getLimit(25).totalVolume);
		System.out.println(order7.parentLimit.limitPrice);
		 System.out.println(book.getOrderBySymbol(1212,false).getVolume());*/
	}
}
